    ...
    <div class="row mt-4">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="d-flex flex-column h-100">
                                <h6 class="mb-3 pt-2">Tổng quan nhân sự</h6>
                                <p><small>Số lượng phòng ban: </small><strong>30</strong></p>
                                <p><small>Số lượng phòng ban: </small><strong>30</strong></p>
                                <p><small>Số lượng phòng ban: </small><strong>30</strong></p>
                                <p><small>Số lượng phòng ban: </small><strong>30</strong></p>
                                <p><small>Số lượng phòng ban: </small><strong>30</strong></p>
                        ...
                        <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                            <div class="h-100">
                                <div class="position-relative d-flex align-items-center justify-content-center h-100">
                                    <img class="w-100 position-relative z-index-2 pt-4" src="../assets/img/image1.png"
                                        alt="tong-quan-nhan-su">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-5">
            <div class="card h-100 p-3">
                <h6 class=" font-weight-bolder mb-4 pt-2">Cập nhật mới</h6>
                <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100"
                    style="background-image: url('../assets/img/ivancik.jpg');">
                    <span class="mask bg-gradient-dark"></span>
                    <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                        <p class="text-white"><small><strong>Số lượng tuyển dụng mới: </strong>Thống kê về số lượng nhân
                                viên mới được
                                tuyển dụng trong một
                                khoảng thời gian cụ thể.</small></p>
                        <p class="text-white"><small><strong>Số lượng nhân viên nghỉ việc: </strong>Thông tin về số
                                lượng nhân viên đã từ
                                chức hoặc chấm
                                dứt hợp đồng lao động.</small></p>
    ...
    <div class="row mt-4">
        ...
        <div class="col-lg-7 h-100">
            <div class="card z-index-2">
                ...
                <div class="card-body p-3">
                    <div class="chart">
                        <canvas id="chart-line" class="chart-canvas" height="465"></canvas>
                    </div>
                </div>
            </div>
        </div>
